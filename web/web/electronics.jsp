<%-- 
    ...
    Created on : 23-Oct-2016, 17:02:50
    Author     : lucifer
--%>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item menu__item--current"><a class="menu__link" href="web/electronics.jsp">Electronics</a></li>
					...
					<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="../checkout.jsp">Apple Iphone 6</a></h4>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="../checkout.jsp">Apple Iphone 6s</a></h4>
									<div class="info-product-price">
